...
export default function Login() {
  ...
  return <main className="login-page">
    ...
    <header className="login-header-wrap"><div className="login-header-inner"><a className="brand" href="/"><span className="brand-mark"><Sparkles size={15}/></span>Mimic</a><a className="back-home" href="/"><ArrowLeft size={15}/> Back to home</a></div></header>
